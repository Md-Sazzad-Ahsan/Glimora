  ...
  return (
    <html lang="en" className="light">
      <head>
        ...
        <meta name="description" content="Streamly is an AI assistant for suggesting and finding movies and dramas based on your mood or story." />
        {/* Open Graph tags */}
        <meta property="og:title" content="Streamly - AI Movie & Drama Suggestion Assistant" />
        ...
        <meta property="og:url" content="https://streamly-psi.vercel.app/" />
        {/* Twitter Card */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Streamly - AI Movie & Drama Suggestion Assistant" />
